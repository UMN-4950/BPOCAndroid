...
public class CircleAnimation {
    ...
    public static void animateCircleToHC(final Circle circle, final LatLng finalPosition, final LatLngInterpolator latLngInterpolator) {
        final LatLng startPosition = circle.getCenter();
    ...
    public static void animateCircleToICS(Circle circle, LatLng finalPosition, final LatLngInterpolator latLngInterpolator) {
